-- Exploratory Data Analysis(EDA) process for Order Priority
...
join gold.dim_order_priority dop
    on fo.order_priority_id = dop.order_priority_id
group by dop.order_priority
order by dop.order_priority desc;